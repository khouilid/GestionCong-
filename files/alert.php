...
if(isset($_GET['msg'])){
    if($_GET['msg'] == 'done'){
        echo "
        <div class=\"alert error alert-success m-0 alert-dismissible fade show\" role=\"alert\">
        ...
        echo "
        <div class=\"alert error alert-danger m-0 alert-dismissible fade show\" role=\"alert\">
